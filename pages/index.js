...
export default function Home({ data }) {
  ...
  const faqData = [
    ...
    {
      question: "Do the buns contain dairy or eggs?",
      answer:
        "The doughs contain dairy, however they do not contain eggs. Some fillings or toppings may be made with egg such as our kaya.",
    },
  ];
